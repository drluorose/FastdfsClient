...
public class TrackerClientTest {
	...
	public void testGetUploadStorageAddr() throws NumberFormatException, UnknownHostException, IOException {
		TrackerClient trackerClient = new TrackerClientImpl("192.168.31.234:22122");
		Result<UploadStorage> result = trackerClient.getUploadStorage();
		assertEquals(0, result.getCode());
		assertEquals("192.168.31.234:23000",result.getData().getAddress());
		trackerClient.close();
	}
	...
	public void testGetDownloadStorageAddr() throws IOException {
		...
		assertEquals(0, result.getCode());
		assertEquals("192.168.31.234:23000",result.getData());
		trackerClient.close();
	}
