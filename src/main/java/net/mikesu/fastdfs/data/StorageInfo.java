...
public class StorageInfo {
    ...
    public StorageInfo(byte[] data, int offset) {
        ...
        connectionAllocCount = (int) AbstractCmd.buff2long(data, offset);
        offset += 4;
        connectionCurrentCount = (int) AbstractCmd.buff2long(data, offset);
        offset += 4;
        connectionMaxCount = (int) AbstractCmd.buff2long(data, offset);
        offset += 4;
